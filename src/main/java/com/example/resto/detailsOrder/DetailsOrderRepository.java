...
public interface DetailsOrderRepository extends JpaRepository<DetailsOrder,String>{
	...
	String getCurrOrder();
        ...
        @Query(nativeQuery = true, value ="select * from etatPlat where etat = 'valide'")
        ...
        @Query(nativeQuery = true, value ="select * from etatPlat where etat = 'pret'")
        List<Object[]> getDetailsOrderPret();
