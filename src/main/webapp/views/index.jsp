...
<body class="animsition">
			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="${baseURL}/views/images/our-story-01.jpg" alt="IMG-OUR">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="section-intro">
		<div class="header-intro parallax100 t-center p-t-135 p-b-158" style="background-image: url(${baseURL}/views/images/bg-intro-01.jpg);">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="${baseURL}/views/images/intro-01.jpg" alt="IMG-INTRO"></a>
							</div>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="${baseURL}/views/images/intro-02.jpg" alt="IMG-INTRO"></a>
							</div>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="${baseURL}/views/images/intro-04.jpg" alt="IMG-INTRO"></a>
							</div>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="${baseURL}/views/images/our-menu-01.jpg" alt="IMG-MENU">
						...
						<div class="col-sm-6">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="${baseURL}/views/images/our-menu-05.jpg" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="${baseURL}/views/images/our-menu-13.jpg" alt="IMG-MENU">
				...
				<div class="col-md-4">
					<div class="row">
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="${baseURL}/views/images/our-menu-08.jpg" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="${baseURL}/views/images/our-menu-10.jpg" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="${baseURL}/views/images/our-menu-16.jpg" alt="IMG-MENU">
	...
	<section class="section-event">
		<div class="wrap-slick2">
			<div class="slick2">
				<div class="item-slick2 item1-slick2" style="background-image: url(${baseURL}/views/images/bg-event-01.jpg);">
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg1-blo2" style="background-image: url(${baseURL}/views/images/event-02.jpg);">
